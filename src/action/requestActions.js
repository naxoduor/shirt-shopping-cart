...
export const fetchCatalogueProducts = (productsurl) => dispatch => {
    ...
    let productsurl = "http://127.0.0.1:8081/products"
...
export const searchProducts = (searchurl, params) => dispatch => {
    ...
    let searchurl = "http://127.0.0.1:8081/products/search"
...
export const fetchDepartments = (departmentsurl) => dispatch => {
    ...
    let departmentsurl = "http://127.0.0.1:8081/departments"
...
export const fetchCategories = (categoriesurl) => dispatch => {
    ...
    let categoriesurl = "http://127.0.0.1:8081/categories"
...
export const fetchCategoriesByDepartment = (departmentcategoriesurl, id) => dispatch => {
    ...
    let departmentcategoriesurl = `http://127.0.0.1:8081/categories/inDepartment/${id}`;
...
export const fetchProductsByDepartment = (departmentproductsurl, id) => dispatch => {
    let departmentproductsurl = `http://127.0.0.1:8081/products/inDepartment/${id}`;
    let obj = {}
...
export const fetchProductsByCategory = (productsurl, id) => dispatch => {
    ...
    let productsurl = `http://127.0.0.1:8081/products/inCategory/${id}`
    let obj = {}
    obj.category_id = id
    axios.get(productsurl)
        .then(res => dispatch({
...
export const generateUniqueCartId = (carturl) => dispatch => {
    ...
    let carturl = "http://127.0.0.1:8081/shoppingcart/generateUniqueId"
    axios.get(carturl)
        .then(res => {
...
export const addToCart = (carturl, cartId, item, quantity) => dispatch => {
    let carturl = 'http://127.0.0.1:8081/shoppingcart/add'
    let params = {}
...
export const updateCartItem = (item_id, quantity) => dispatch => {
    ...
    let carturl = `http://127.0.0.1:8081/shoppingcart/update/${joined_ids}`
    let params = {}
    let itemList = []
    params.quantity = quantity
...
export const fetchCartItems = (carturl, cart_id) => dispatch => {
    ...
    let itemList=[]
    let carturl = `http://127.0.0.1:8081/shoppingcart/${cart_id}`
    console.log(carturl)
    axios.get(carturl)
        .then(res => dispatch({
            type: FETCH_CART_ITEMS,
...
export const fetchCartTotalAmount = (carturl, cart_id) => dispatch => {
    ...
    let carturl = `http://127.0.0.1:8081/shoppingcart/totalamount/${cart_id}`
    axios.get(carturl)
        .then(res => dispatch({
...
export const fetchTotalDepartmentItems = (totalitemsurl, id) => dispatch => {
    ...
    let totalitemsurl = `http://127.0.0.1:8081/departments/totalitems/${id}`
...
export const fetchTotalCategoryItems = (totalitemsurl, id) => dispatch => {
    ...
    let totalitemsurl = `http://127.0.0.1:8081/categories/totalitems/${id}`
...
export const removeCartProduct = (carturl, item_id) => dispatch => {
    ...
    let paramstr='&'
    let joined_ids=`${item_id}${paramstr}${cart_id}`
    let carturl = `http://127.0.0.1:8081/shoppingcart/removeProduct/${joined_ids}`
...
export const signupUser = (username, email, password, mobile) => dispatch => {
    axios.post('http://127.0.0.1:8081/customers', { username, email, password, mobile })
        .then(res => dispatch({
...
export const signinUser = (email, password) => dispatch => {
    axios.post('http://127.0.0.1:8081/customers/login', { email, password })
        .then(res => {
...
export const signOutUser = () => dispatch => {
    axios.get('http://127.0.0.1:8081/customers/logout')
        .then((res) => {
...
export const fetchDepartmentPaginationProducts = (finalurl, id, params) => dispatch => {
    ...
    let finalurl = `http://127.0.0.1:8081/products/inDepartment/pagination/${id}`
    let obj = {}
...
export const fetchAttributes = (product_id) => dispatch => {
    ...
    let attributesurl = `http://127.0.0.1:8081/attributes/inAttribute/${product_id}`
...
export const fetchCategoryPaginationProducts = (finalurl, id, params) => dispatch => {
    ...
    let finalurl = `http://127.0.0.1:8081/products/inCategory/pagination/${id}`
    let obj = {}
...
export const fetchShippingRegions = () => dispatch => {
    ...
    axios.get('http://127.0.0.1:8081/shipping/regions/')
        .then(res => dispatch({
...
export const fetchShippingInformation = (shipping_id) => dispatch => {
    let shipping = {}
    let shippinginfourl = `http://127.0.0.1:8081/shipping/regions/regionId/${shipping_id}`
...
export const createOrder = (order) => dispatch => {
    axios.post('http://127.0.0.1:8081/orders', { order })
        .then(res=>dispatch({
...
export const authorizeCheckout = (token) => dispatch => {
    ...
    console.log(token)
    axios.get('http://127.0.0.1:8081/protected', { headers: { authorization: `Bearer ${token}` } })
        .then(res => res.data)
...
export const findOrderDetails = (dates) => dispatch => {
    axios.post('http://127.0.0.1:8081/orderdetails', { dates })
        .then(res => dispatch({
            type: FETCH_ORDER_DETAILS,
            payload: res.data
        }))
...
export const passwordReset = (email) => dispatch => {
    ...
    axios.post('http://127.0.0.1:8081/customers/passwordreset', { email })
        .then(res => res.data)
        .then(token => {
            const message = {
