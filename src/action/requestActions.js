...
export const fetchCategoriesByDepartment = (departmentcategoriesurl, id) => dispatch => {
    ...
    let departmentcategoriesurl="http://104.248.73.139:8080/categories/inDepartment/?id=" + id;
...
export const fetchProductsByDepartment = (departmentproductsurl, id) => dispatch => {
    ...
    console.log(id)
    let departmentproductsurl="http://104.248.73.139:8080/products/inDepartment/?id=" + id;
    let obj = {}
...
export const fetchProductsByCategory = (productsurl,  id) => dispatch => {
    ...
    let productsurl="http://104.248.73.139:8080/products/inCategory/?id=" + id;
    let obj = {}
    obj.category_id = id
    axios.get(productsurl)
        .then(res => res.data)
...
export const fetchCartItems = (carturl, cart_id) => dispatch => {
    ...
    let carturl="http://104.248.73.139:8080/shoppingcart/?cart_id=" + cart_id
    console.log(carturl)
    axios.get(carturl)
        .then(res => res.data)
...
export const fetchCartTotalAmount = (carturl, cart_id) => dispatch => {
    ...
    let carturl="http://104.248.73.139:8080/shoppingcart/totalamount/?cart_id=" + cart_id
    axios.get(carturl)
        .then(res => res.data)
...
export const fetchTotalDepartmentItems = (totalitemsurl, id) => dispatch => {
    ...
    let totalitemsurl="http://104.248.73.139:8080/departments/totalitems/?id=" + id;
...
export const fetchTotalCategoryItems = (totalitemsurl, id) => dispatch => {
    ...
    let totalitemsurl="http://104.248.73.139:8080/categories/totalitems/?id=" + id;
...
export const removeCartProduct = (carturl, item_id) => dispatch => {
    ...
    let carturl=`http://104.248.73.139:8080/shoppingcart/removeProduct/?item_id=${item_id}`
...
export const fetchShippingInformation = (shipping_id) => dispatch => {
    ...
    let shipping = {}
    let shippinginfourl=`http://104.248.73.139:8080/shipping/regions/regionId/?shipping_region_id=${shipping_id}`
