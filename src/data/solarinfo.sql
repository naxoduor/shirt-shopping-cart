...
INSERT INTO `product` (`product_id`, `name`, `description`, `price`, `discounted_price`, `image`, `image_2`, `thumbnail`, `display`) VALUES
       (1, 'solarmax  Solar Africa SolarMax 150W 12V Mono crystalline solar panel,High efficiency cells', 'roduct detailsType: mono crystalineUse: Inverter ChargingDurability: HighCell Efficiency: HighInstallation: Use Expert like usSolar
...
', 'KSh 8,600', 0.00, 'solarmax1.jpg', 'solarmax1.jpg', 'solarmax1.jpg', 0),
(2, 'solarmax  Poly 100 Watt Solar Panel', ' High     module conversion efficiency. Ideal output for single panel: 100Wh per day     (depending on the availability of sunlight).    Bypass     diode minimizes power drop caused by shade and ensures excellent     performance in low-light environmentswork with     all weather even when there is mist and rainlyEL tested     solar modules; no hot-spot heating guaranteed.Advanced     encapsulation material with multilayered sheet laminations to enhance cell     performance and provide a long service life. Corrosion-resistant     aluminum frame for extended outdoor use, allowing the panels to last for     decades as well as withstand high winds (2400Pa.  Anti-reflective,     high transparency, low iron-tempered glass with enhanced stiffness and     impact resistance..TPT back     sheet ensures smooth performance over a long period of time', 'specificationsKey Features·        Open Circuit Voltage: 15.5V ·        Short Circuit Current: 6.37A  ·        Max Power Voltage: 17.5V ·        Max Power Current: 5.71A ·        Max System Voltage: 700VDC·        25 year life expectancyWhat’s in the box1*PanelSpecificationsSKU: SO830HL020E56NAFAMZMain Material: Metal and GlassSize (L x W x H cm): 90 x 50 x 8Weight (kg):
', 'KSh 6,960', 8700.00, 'solarmax2.jpg', 'solarmax2.jpg', 'solarmax2.jpg', 0),
(3, 'solarmax  Solar 120 Watt Solar Panel ( All Weather) Poly', 'Product detailssolarmax solar panel have  high efficiency solar modules are constructed from 36 
...
', 'KSh 15,800', 20,800.00, 'solarmax4.jpg', 'solarmax4.jpg', 'solarmax4.jpg', 0),
(5, 'solarmax 100 watt Solar Panel,charger controller, 300watt inverter, 3 bulbs', 'Product detailssolarmax solar panel have  high efficiency solar modules are constructed from 36 
polycrystalline, (12V modules) or 72 cells (24V modules) cells. The 
cells are individually tested and matched for optimum performance before
 being built into the protective module structure. A Tedlar® base is 
used and ethylene vinyl acetate encapsulant. High transmission tempered 
...
', 'KSh 6, 999', 10,999.00, 'solarmax8.jpg', 'solarmax8.jpg', 'solarmax8.jpg', 0),
...
41" Cable with MC4 Connector', 'NEW', 'KSh 15,273', 15,273.00, 'suntech11.jpg', 'suntech11.jpg', 'suntech11.jpg', 0),
